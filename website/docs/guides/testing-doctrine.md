...
|---|---|---|---|---|
| **unit** | `pnpm run test` (inside `check`) | node + jsdom, **no database** | {/*count:test-files*/}98{/*/count*/} test files | every `check`, locally and in CI |
...
| **e2e** | `pnpm run e2e` | real Chromium over the real stack | {/*count:e2e-tests*/}15{/*/count*/} tests / {/*count:e2e-specs*/}6{/*/count*/} specs | the CI `e2e` job |
...
{/*count:config-regression*/}58{/*/count*/} tests whose subject is the **enforcers**. Two shapes, and the difference is
