...
*Read this if you are deploying the container target or preparing the DR cold standby. Per-tenant TLS and the domain model live on [Custom domains & TLS](./self-host-and-domains.md).*
