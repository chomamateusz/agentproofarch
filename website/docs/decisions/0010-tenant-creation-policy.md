...
### 1. One env key, three modes 🔑 \{#1-one-env-key-three-modes}
...
### 2. The policy stays data 🗄️ \{#2-the-policy-stays-data}
...
### 3. `staff` requires the create path to see staff-ness 🧑‍💼 \{#3-staff-requires-the-create-path-to-see-staff-ness}
