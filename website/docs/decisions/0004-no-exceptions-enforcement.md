...
- **Some jobs report without blocking.** Each is deliberately non-required for a stated reason — the current list lives in [CI gates](../operations/ci-gates.md#deliberately-non-required); `ai-review` graduated to the `main-gates` required set on 2026-07-26.
:::
