...
export const MAILPIT_SMTP_PORT = Number(process.env['MAILPIT_SMTP_PORT'] ?? '47925');
export const MAILPIT_API_URL = process.env['MAILPIT_API_URL'] ?? 'http://localhost:47980';
